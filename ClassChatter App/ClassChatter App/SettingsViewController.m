...
- (IBAction)showInformation:(UIButton *)sender {
    ...
    UILabel *informationLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.informationView.bounds.origin.x + 20, self.informationView.bounds.origin.y + 20, self.informationView.bounds.size.width - 40, self.informationView.bounds.size.height + 630)];
